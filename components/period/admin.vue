<template>
    <div class="mx-auto px-8">
        <div class="flex gap-4 flex-wrap">
            ...
            <div @click="isOpen = true" class="cursor-pointer rounded-full flex items-center justify-center w-14 h-14 text-[3rem] pb-1.5 text-white bg-[#08B3B9] shrink-0">+</div>
        </div>
        ...
        <div v-if="isOpen" class="fixed px-4 left-0 top-0 w-full h-full bg-[#0000004D] backdrop-blur-[0.125rem] z-[100] flex items-center justify-center"
            @click="isOpen = false">
